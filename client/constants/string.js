...
export const ALLOWED_RANGE = 'Phạm vi cho phép';
export const MODE_AUTOMATIC_DESCRIPTION = "Blah blah";
export const MODE_MANUAL_DESCRIPTION = "...";
export const MODE_SCHEDULED_DESCRIPTION = "1234231";